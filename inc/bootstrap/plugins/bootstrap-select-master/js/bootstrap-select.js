(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createLi: function () {
       ...
       * @returns {string}
       */
      var generateA = function (text, classes, inline, title, tokens) {
        return '<a tabindex="0"' +
      ...
      $selectOptions.each(function (index) {
        ...
        if (isOptgroup && $this.data('divider') !== true) {
          ...
          _li.push(generateLI(generateA(text, 'opt ' + optionClass + optGroupClass, inline, title, tokens), index, '', optID));
          ...
          _li.push(generateLI(generateA(text, optionClass, inline, title, tokens), index, 'hidden is-hidden'));
        } else {
          ...
          _li.push(generateLI(generateA(text, optionClass, inline, title, tokens), index));
        }
