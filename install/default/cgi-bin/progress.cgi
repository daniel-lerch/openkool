	...
	<head>
	 <title>File upload status</title>
 	 <meta HTTP-EQUIV=Refresh CONTENT="$interval; URL=$url"></head>
		<style type="text/css">
	  <!--
		p,td { font-family:sans-serif; font-size: 11px; }
    -->
    </style>
	 </head>
	<body bgcolor="#eeeeee">
		<table style="border: 1px solid #999999;" width="100%">
		  <tr><TD align="center"  bgcolor="#AAAAFF"><b>file upload is in progress</b></td></tr>
		  <tr><td>
			    <table style="border: 1px solid #999999;background-color:#EEEEEE" width='100%'>
			  <tr><td>
			   <table style="background-color:#AAAAFF" width='$percent%'>
		   ...
		   <tr>
			 <td>
					Status: $bRead bytes of $iTotal transmitted ($bSpeedf Kbps)<br />
					Time left: $dtRemainingf<br />
					Time passed: $dtelapsedf<br />
				</td>
			</tr>
		</table>
	</body>
...
sub show_complete
{
	...
	print <<__PART2__;
		...
		<tr><td>
		  <table align="center">
		   <tr><td align="center" bgcolor="#AAAAFF"><b>File upload complete</b></td></tr>
			<tr>
				<td>
					Status: $bRead bytes of $iTotal transmitted ($bSpeedf Kbps)<br />
					Time left: 00:00:00<br />
					Time passed: $dtelapsedf<br />
				</td>
			</tr>
		   <tr><td align="center"><a href="javascript:parent.window.close();">close window</a></td></tr>
		  </table>
		</td></tr>
		</table>
		</body>
...
sub show_starting
{
	...
	print <<__PART2__;
		...
		<table style="border: 1px solid #999999;" width="100%">
		<tr><td>
		 <table bgcolor="#AAAAFF" width="100%">
		 <tr><td align="center">
		 <b>File upload is beeing initialized</b>
		 </td></tr>
		 </table>
		</td></tr>
		</table>
...
sub show_error
{
	...
	print <<__PART2__;
		<html>
		<head><title>File Upload Complete</title>
		<meta HTTP-EQUIV=Refresh CONTENT="$interval; URL=$url">
		<style type="text/css">
		<!--
		p,td { font-family:sans-serif; font-size: 11px; }
		...
		<tr><td>
		 <table bgcolor="#AAAAFF" width="100%">
		 <tr><td align="center">
		 <b>File upload is in progress, filesize unknown.</b>
		 </td></tr>
		 </table>
		</td></tr>
		</table>
