...
CREATE TABLE `ko_fileshare_folders` (
  ...
  `share_users` text NOT NULL DEFAULT '',
...
INSERT INTO `ko_help` VALUES(NULL, 'admin', 'login_rights_daten', 'de', 0, 0, '<b>2: </b>Zu den gewählten Termingruppen dürfen neue Termine erfasst, bestehende bearbeitet und gelöscht werden (inkl. Moderation gemäß Einstellung pro Termingruppe)<br />\r\n<b>3: </b>Rechte von 2 aber ohne Moderation auch bei moderierten Termingruppen<br/>\r\n<b>4: </b>Von Stufe-2-Benutzern erfasste Termine moderieren<br />\r\n<b>ALL-Rechte auf 3:</b><br />Termingruppen/Kalender erstellen');
...
INSERT INTO `ko_help` VALUES(NULL, 'admin', 'login_rights_fileshare', 'de', 0, 0, 'Diese Modul wird nur benötigt, wenn der Benutzer Webordner anlegen oder bearbeiten muss. Für den Zugriff auf die Dateien im Webordner muss dieses Modul nicht gewählt werden.');
...
INSERT INTO `ko_help` VALUES(NULL, 'donations', 'submenu_filter_amount', 'de', 0, 0, '<h1>Suche nach Betrag:</h1><ul><li><b>100-200</b>: Betrag zwischen 100 und 200 (inklusive)</li><li><b>&gt;100</b>: Betrag größer als 100 (inklusive)</li><li><b>&lt;100</b>: Betrag kleiner als 100 (inklusive)</li><li><b>=100</b>: Betrag exakt 100</li><li><b>Sonstige Eingaben</b>: Teilsuche, z.B. "100" findet "100" aber auch "1000" oder "1009"</li></ul>');
...
INSERT INTO `ko_settings` VALUES('db_migration', '1')
